    ...
    >
      ...
      <div className="container relative z-10 py-20 lg:py-0">
        <div className="lg:pl-12">
          ...
          >
            <span className="font-display italic text-gold text-[1.35em]">The Roundtable</span> is your personal advisory board, on-demand.<br></br> 60+ experts debate your decisions and
