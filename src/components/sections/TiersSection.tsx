...
const TiersSection = () => {
  ...
  const tiers = [
    ...
    },
    {
      ...
      description: "Define how your company actually makes decisions.",
      detail: "Perspectives grounded in your reality.",
    ...
    },
    {
      ...
      description: "The version of you you’re becoming, before you get there.",
