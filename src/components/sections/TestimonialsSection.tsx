      ...
      <div className="container relative z-10">
        ...
        <div className="lg:pl-12 mb-12">
          <div className="flex items-center gap-3 mb-4">
            ...
            <span className="label">What people notice</span>
          </div>
          <h2 className="font-display text-ink">After using the Roundtable</h2>
        </div>
        ...
        <div className="lg:pl-12 grid md:grid-cols-2 lg:grid-cols-3 gap-4">
          {testimonials.map((t, i) => (
            <div
              key={i}
              className="bg-white p-6 relative group transition-all duration-500 hover:shadow-soft hover:-translate-y-1"
            >
              ...
              <blockquote className="font-display text-base text-ink italic leading-relaxed mb-6 relative z-10 transition-colors duration-300 group-hover:text-gold-dark">
                "{t.quote}"
              </blockquote>
        ...
        <div className="mt-10 text-center">
          <p className="text-xs text-warm-gray italic">Real words from real clients. Shared with permission.</p>
        </div>
      </div>
    </section>
  );
