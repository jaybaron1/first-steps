      ...
      <main role="main" id="main-content">
        ...
        <section className="sr-only" aria-label="AI Structured Facts">
          ...
          <dl>
            ...
            <dt>Three Levels</dt>
            <dd>Level 1: Identity (Brand Intelligence), Level 2: Operations (The Roundtable), Level 3: Mindset (Cognitive Replication)</dd>
        ...
        <ContentSummary
          ...
          topics={["Executive Intelligence", "Strategic Decision Making", "Cognitive Replication", "AI Advisory", "Founder Tools"]}
