      ...
      <div className="admin-theme min-h-screen bg-[hsl(var(--admin-bg))] flex items-center justify-center p-4">
        ...
        <div className="relative w-full max-w-md">
          ...
          <div className="text-center mb-8">
            ...
            <h1 className="text-2xl font-semibold text-[hsl(var(--admin-text))] font-display mb-1">Admin Portal</h1>
          ...
          <div className="bg-[hsl(var(--admin-bg-elevated))] border border-[hsl(var(--admin-border-subtle))] rounded-2xl p-8 shadow-xl">
              ...
              <form onSubmit={handleLogin} className="space-y-6">
                ...
                {isLockedOut && (
                  <div className="flex items-center gap-3 p-4 bg-amber-500/10 border border-amber-500/20 rounded-lg">
                    ...
                    <div>
                      <p className="text-sm text-amber-600 dark:text-amber-400 font-medium">Account Temporarily Locked</p>
                ...
                <div className="space-y-2">
                  <Label htmlFor="email" className="text-sm text-[hsl(var(--admin-text-muted))]">
                    Email Address
                  </Label>
                  <div className="relative">
                    ...
                    <Input
                      ...
                      className="pl-11 h-12 bg-[hsl(var(--admin-bg))] border-[hsl(var(--admin-border))] text-[hsl(var(--admin-text))] placeholder:text-[hsl(var(--admin-text-subtle))] focus:border-[#B8956C]/50 focus:ring-[#B8956C]/20"
                      required
                    />
                  </div>
                </div>
                ...
                <div className="space-y-2">
                  <div className="flex items-center justify-between">
                    <Label htmlFor="password" className="text-sm text-[hsl(var(--admin-text-muted))]">
                      Password
                    </Label>
                    <button
                      type="button"
                      onClick={() => setView('reset')}
                      className="text-xs text-[#B8956C] hover:text-[#B8956C]/80 transition-colors"
                    >
                      Forgot password?
                    </button>
                  </div>
                  <div className="relative">
                    ...
                    <Input
                      ...
                      placeholder="••••••••"
                      disabled={isLoading || isLockedOut}
                      className="pl-11 pr-11 h-12 bg-[hsl(var(--admin-bg))] border-[hsl(var(--admin-border))] text-[hsl(var(--admin-text))] placeholder:text-[hsl(var(--admin-text-subtle))] focus:border-[#B8956C]/50 focus:ring-[#B8956C]/20"
                      required
                    />
                    <button
                      type="button"
                      onClick={() => setShowPassword(!showPassword)}
                      className="absolute right-3 top-1/2 -translate-y-1/2 text-[hsl(var(--admin-text-subtle))] hover:text-[hsl(var(--admin-text-muted))]"
                    >
                ...
                <Button
                  type="submit"
                  disabled={isLoading || isLockedOut}
                  className="w-full h-12 bg-[#B8956C] hover:bg-[#B8956C]/90 text-white font-medium rounded-lg transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed"
                >
                  {isLoading ? (
                ...
                <div className="text-center">
                  <p className="text-sm text-[hsl(var(--admin-text-subtle))]">
                    ...
                    <button
                      ...
                      className="text-[#B8956C] hover:text-[#B8956C]/80 transition-colors"
                    >
                      Request access
                    </button>
                  </p>
            ...
            {view === 'signup' && (
              <form onSubmit={handleSignup} className="space-y-6">
                <div className="text-center mb-2">
                  ...
                  <p className="text-sm text-[hsl(var(--admin-text-subtle))] mt-1">
                ...
                {/* Email Field */}
                <div className="space-y-2">
                  <Label htmlFor="signup-email" className="text-sm text-[hsl(var(--admin-text-muted))]">
                    Email Address
                  </Label>
                  <div className="relative">
                    <Mail className="absolute left-3 top-1/2 -translate-y-1/2 w-5 h-5 text-[hsl(var(--admin-text-subtle))]" />
                ...
                {/* Password Field */}
                <div className="space-y-2">
                  <Label htmlFor="signup-password" className="text-sm text-[hsl(var(--admin-text-muted))]">
                    Password
                  </Label>
                  <div className="relative">
                    <Lock className="absolute left-3 top-1/2 -translate-y-1/2 w-5 h-5 text-[hsl(var(--admin-text-subtle))]" />
                ...
                <div className="space-y-2">
                  <Label htmlFor="confirm-password" className="text-sm text-[hsl(var(--admin-text-muted))]">
                    Confirm Password
                  </Label>
                  <div className="relative">
                    <Lock className="absolute left-3 top-1/2 -translate-y-1/2 w-5 h-5 text-[hsl(var(--admin-text-subtle))]" />
                ...
                <Button
                  type="submit"
                  disabled={isLoading}
                  className="w-full h-12 bg-[#B8956C] hover:bg-[#8A6D4E] text-white font-medium rounded-lg transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed"
                >
                  {isLoading ? (
                    <div className="flex items-center gap-2">
                      <div className="w-4 h-4 border-2 border-white/30 border-t-white rounded-full animate-spin" />
                ...
                <Button
                  ...
                  className="w-full h-12 text-[hsl(var(--admin-text-muted))] hover:text-[hsl(var(--admin-text))] hover:bg-[hsl(var(--admin-bg-card))]"
                >
                  Back to Sign In
                </Button>
              </form>
            ...
            {view === 'reset' && (
              <form onSubmit={handlePasswordReset} className="space-y-6">
                ...
                <div className="space-y-2">
                  <Label htmlFor="reset-email" className="text-sm text-[hsl(var(--admin-text-muted))]">
                    Email Address
                  </Label>
                  <div className="relative">
                    <Mail className="absolute left-3 top-1/2 -translate-y-1/2 w-5 h-5 text-[hsl(var(--admin-text-subtle))]" />
                ...
                <div className="space-y-3">
                  <Button
                    type="submit"
                    disabled={isLoading}
                    className="w-full h-12 bg-[#B8956C] hover:bg-[#B8956C]/90 text-white font-medium rounded-lg"
                  >
            ...
            {view === 'reset-sent' && (
              <div className="text-center space-y-6">
                <div className="inline-flex items-center justify-center w-16 h-16 rounded-full bg-[#B8956C]/10 border border-[#B8956C]/20">
                  <Mail className="w-8 h-8 text-[#B8956C]" />
                </div>
                <div>
                  <h2 className="text-lg font-medium text-[hsl(var(--admin-text))]">Check Your Email</h2>
                  <p className="text-sm text-[hsl(var(--admin-text-subtle))] mt-2">
                    We've sent password reset instructions to{' '}
                    <span className="text-[hsl(var(--admin-text-muted))]">{email}</span>
                  </p>
                </div>
                <Button
                  type="button"
          ...
          {/* Footer */}
          <p className="text-center text-xs text-[hsl(var(--admin-text-subtle))] mt-6">
